...
public class URL {
    ...
    public static URL valueOf(String url) {
        if (Strings.isNullOrEmpty(url)) {
            throw new KobeServiceException("url is null");
        }
    ...
    public boolean canServe(URL refUrl) {
        ...
        if (!Objects.equal(protocol, refUrl.protocol)) {
            return false;
        }

        if (!Objects.equal(this.getParameter(URLParam.nodeType.getName()), Constants.NODE_TYPE_SERVICE)) {
            return false;
        }
    ...
    public boolean hasParameter(String key) {
        return Strings.isNullOrEmpty(getParameter(key));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equal(this.path, ou.path)) {
            return false;
        }
        return Objects.equal(this.parameters, ou.parameters);
    }
